...
Dict nvim__buf_stats(Buffer buf, Arena *arena, Error *err)
{
  ...
  PUT_C(rv, "mmap_piece_write_raw_original_count",
        INTEGER_OBJ((Integer)ml_buf_mmap_piece_write_raw_original_count(b)));
  ...
  PUT_C(rv, "mmap_search_prefilter_miss_count",
        INTEGER_OBJ((Integer)ml_buf_mmap_search_prefilter_miss_count(b)));
  PUT_C(rv, "mmap_substitute_literal_count",
        INTEGER_OBJ((Integer)ml_buf_mmap_substitute_literal_count(b)));
  PUT_C(rv, "mmap_substitute_literal_line_count",
        INTEGER_OBJ((Integer)ml_buf_mmap_substitute_literal_line_count(b)));
  PUT_C(rv, "mmap_line_buf_cap", INTEGER_OBJ((Integer)ml_buf_mmap_line_buf_cap(b)));
  PUT_C(rv, "mmap_piece_journal_active",
        BOOLEAN_OBJ(ml_buf_mmap_piece_journal_active(b)));
  PUT_C(rv, "mmap_piece_journal_failed",
        BOOLEAN_OBJ(ml_buf_mmap_piece_journal_failed(b)));
  PUT_C(rv, "mmap_piece_journal_dirty",
        BOOLEAN_OBJ(ml_buf_mmap_piece_journal_dirty(b)));
  PUT_C(rv, "mmap_piece_journal_record_count",
        INTEGER_OBJ((Integer)ml_buf_mmap_piece_journal_record_count(b)));
  PUT_C(rv, "mmap_piece_journal_bytes",
        INTEGER_OBJ((Integer)ml_buf_mmap_piece_journal_bytes(b)));
  PUT_C(rv, "mmap_piece_journal_path",
        CSTR_AS_OBJ(ml_buf_mmap_piece_journal_path(b)));
  ...
  PUT_C(rv, "mmap_piece_reclaim_scheduled",
        BOOLEAN_OBJ(ml_buf_mmap_piece_reclaim_scheduled()));
  PUT_C(rv, "mmap_piece_gc_worker_active",
        BOOLEAN_OBJ(ml_buf_mmap_piece_gc_worker_active()));
